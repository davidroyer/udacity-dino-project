...
const GridItemContent = item => {
  function factRenderer(item) {
    if (item.species !== "human") return `<p>${item.fact}</p>`;else return "";
  }

  const nameRenderer = item => {
    if (item.species == "human") return `${item.name}`;else return item.species;
  };
...
},{"core-js/library/fn/object/create":"../node_modules/core-js/library/fn/object/create.js"}],"helpers/index.js":[function(require,module,exports) {
"use strict";
...
exports.getTotalInches = getTotalInches;
exports.convertToNumber = convertToNumber;
exports.randomIntFromInterval = randomIntFromInterval;
exports.isPositiveNumber = isPositiveNumber;
exports.isExtinctDino = isExtinctDino;
exports.compareHeight = compareHeight;
exports.compareWeight = compareWeight;
exports.compareDiet = compareDiet;
...
function inheritFromParent(Child, Parent) {
  Child.prototype = (0, _create.default)(Parent.prototype);
  Child.prototype.constructor = Child;
}

function insertIntoArray(array, insertPosition, insertValue) {
  array.splice(insertPosition, 0, insertValue); // return [...array].splice(insertPosition, 0, insertValue); // Maybe for immutability
}
...
function getTotalInches(value1, value2) {
...
function isExtinctDino(species) {
...
function compareHeight(human, dino) {
  ...
  const dinoTallerText = `The ${dino.species} is taller than you by ${-heightDifference} inches`;
  if (largerCreature === "human") return humanTallerText;else return dinoTallerText;
}
/**
 * Comparison Method 2
 */
...
function compareWeight(human, dino) {
  ...
  const dinoHeavierText = `The ${dino.species} is heavier than you by ${-weightDifference} lbs`;
  if (heavierCreature === "human") return humanHeavierText;else return dinoHeavierText;
}
/**
 * Comparison Method 3
 * @todo
...
},{"@babel/runtime-corejs2/core-js/object/create":"../node_modules/@babel/runtime-corejs2/core-js/object/create.js"}],"../node_modules/core-js/library/modules/_object-gops.js":[function(require,module,exports) {
...
},{"core-js/library/fn/object/assign":"../node_modules/core-js/library/fn/object/assign.js"}],"models/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CreatureConstructor = CreatureConstructor;
 ...
 */
function CreatureConstructor(creatureObject) {
  (0, _assign.default)(this, creatureObject);
}
...
function DinoConstructor(dinoObject) {
  ...
  this.facts = [this.fact, `The ${this.species} lived in ${this.where}.`, `The ${this.species} was a ${this.diet}.`];
...
(0, _helpers.inheritFromParent)(HumanConstructor, CreatureConstructor);
(0, _helpers.inheritFromParent)(DinoConstructor, CreatureConstructor);

function setFact(newValue) {
  this.fact = newValue;
}
},{"@babel/runtime-corejs2/core-js/object/assign":"../node_modules/@babel/runtime-corejs2/core-js/object/assign.js","../helpers":"helpers/index.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
async function loadGrid(human) {
  ...
  const creaturesArray = Dinos.map(dino => new _models.DinoConstructor(dino));
  const grid = document.getElementById("grid");
  (0, _helpers.insertIntoArray)(creaturesArray, 4, human);
  creaturesArray.forEach(creature => {
    if ((0, _helpers.isExtinctDino)(creature.species)) {
      creature.facts = [...creature.facts, (0, _helpers.compareWeight)(human, creature), (0, _helpers.compareHeight)(human, creature), (0, _helpers.compareDiet)(human, creature)];
    ...
    gridItemWrapper.innerHTML = (0, _Card.default)(creature);
...
function handleFormSubmission() {
  ...
  form.addEventListener("submit", event => {
    ...
    const height = (0, _helpers.convertToInches)(heightFeet) + (0, _helpers.convertToNumber)(heightInches);
    let human = new _models.HumanConstructor({
      name,
      height,
      diet,
      species,
      weight: (0, _helpers.convertToNumber)(weight)
    });
    loadGrid(human);
...
},{"./components/Card":"components/Card.js","./helpers/":"helpers/index.js","./models":"models/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
